...
public class InlineQueryResultCachedSticker {
    ...
    public InlineQueryResultCachedSticker(String type, String id, String stickerFileId, InlineKeyboardMarkup replyMarkup, InputMessageContent inputMessageContent) {
        this.type = type;
        this.id = id;
